...
void _productTypeEntitySerialize(
  ...
  writer.writeString(offsets[7], object.displayUnit);
  ...
  writer.writeString(offsets[14], object.skuPrefix);
  writer.writeByte(offsets[15], object.syncStatus.index);
  writer.writeStringList(offsets[16], object.tabs);
...
ProductTypeEntity _productTypeEntityDeserialize(
  ...
  object.displayUnit = reader.readStringOrNull(offsets[7]);
  ...
  object.skuPrefix = reader.readStringOrNull(offsets[14]);
  object.syncStatus = _ProductTypeEntitysyncStatusValueEnumMap[
          reader.readByteOrNull(offsets[15])] ??
      SyncStatus.pending;
  object.tabs = reader.readStringList(offsets[16]);
...
extension ProductTypeEntityQueryProperty
  ...
  QueryBuilder<ProductTypeEntity, String, QQueryOperations> deviceIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductTypeEntity, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductTypeEntity, int, QQueryOperations> versionProperty() {
    return QueryBuilder.apply(this, (query) {

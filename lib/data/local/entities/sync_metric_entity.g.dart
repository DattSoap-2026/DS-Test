...
part of 'sync_metric_entity.dart';
...
extension GetSyncMetricEntityCollection on Isar {
  IsarCollection<SyncMetricEntity> get syncMetricEntitys => this.collection();
}

const SyncMetricEntitySchema = CollectionSchema(
  name: r'SyncMetricEntity',
  id: 7057648776139719644,
  properties: {
  ...
  serialize: _syncMetricEntitySerialize,
  deserialize: _syncMetricEntityDeserialize,
  deserializeProp: _syncMetricEntityDeserializeProp,
  idName: r'isarId',
  indexes: {
  ...
  links: {},
  embeddedSchemas: {},
  getId: _syncMetricEntityGetId,
  getLinks: _syncMetricEntityGetLinks,
  attach: _syncMetricEntityAttach,
  version: '3.1.0+1',
);

int _syncMetricEntityEstimateSize(
  SyncMetricEntity object,
  List<int> offsets,
...
void _syncMetricEntitySerialize(
  SyncMetricEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _syncMetricEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
const _SyncMetricEntityoperationEnumValueMap = {
  'push': 0,
  'pull': 1,
};
const _SyncMetricEntityoperationValueEnumMap = {
  0: SyncOperation.push,
  1: SyncOperation.pull,
};
const _SyncMetricEntitysyncStatusEnumValueMap = {
  'pending': 0,
  'synced': 1,
  'conflict': 2,
};
const _SyncMetricEntitysyncStatusValueEnumMap = {
  0: SyncStatus.pending,
  1: SyncStatus.synced,
  2: SyncStatus.conflict,
};

Id _syncMetricEntityGetId(SyncMetricEntity object) {
  return object.isarId;
}

List<IsarLinkBase<dynamic>> _syncMetricEntityGetLinks(SyncMetricEntity object) {
  return [];
}

void _syncMetricEntityAttach(
    IsarCollection<dynamic> col, Id id, SyncMetricEntity object) {}

extension SyncMetricEntityByIndex on IsarCollection<SyncMetricEntity> {
  Future<SyncMetricEntity?> getByMetricId(String metricId) {
    return getByIndex(r'metricId', [metricId]);
  }

  SyncMetricEntity? getByMetricIdSync(String metricId) {
  ...
  Future<List<SyncMetricEntity?>> getAllByMetricId(
      List<String> metricIdValues) {
    final values = metricIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'metricId', values);
  }

  List<SyncMetricEntity?> getAllByMetricIdSync(List<String> metricIdValues) {
    final values = metricIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByMetricId(SyncMetricEntity object) {
    return putByIndex(r'metricId', object);
  }

  Id putByMetricIdSync(SyncMetricEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'metricId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByMetricId(List<SyncMetricEntity> objects) {
    return putAllByIndex(r'metricId', objects);
  }

  List<Id> putAllByMetricIdSync(List<SyncMetricEntity> objects,
      {bool saveLinks = true}) {
    return putAllByIndexSync(r'metricId', objects, saveLinks: saveLinks);
  }

  Future<SyncMetricEntity?> getById(String id) {
    return getByIndex(r'id', [id]);
  }

  SyncMetricEntity? getByIdSync(String id) {
  ...
  Future<List<SyncMetricEntity?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<SyncMetricEntity?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(SyncMetricEntity object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(SyncMetricEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<SyncMetricEntity> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<SyncMetricEntity> objects,
      {bool saveLinks = true}) {
    return putAllByIndexSync(r'id', objects, saveLinks: saveLinks);
  }
}

extension SyncMetricEntityQueryWhereSort
    on QueryBuilder<SyncMetricEntity, SyncMetricEntity, QWhere> {
  QueryBuilder<SyncMetricEntity, SyncMetricEntity, QAfterWhere> anyIsarId() {
...
extension SyncMetricEntityQueryWhere
    on QueryBuilder<SyncMetricEntity, SyncMetricEntity, QWhereClause> {
  QueryBuilder<SyncMetricEntity, SyncMetricEntity, QAfterWhereClause>
  ...
  QueryBuilder<SyncMetricEntity, SyncMetricEntity, QAfterWhereClause> idEqualTo(
      String id) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'id',
...
extension SyncMetricEntityQueryFilter
    on QueryBuilder<SyncMetricEntity, SyncMetricEntity, QFilterCondition> {
...
extension SyncMetricEntityQueryLinks
    on QueryBuilder<SyncMetricEntity, SyncMetricEntity, QFilterCondition> {}

extension SyncMetricEntityQuerySortBy
    on QueryBuilder<SyncMetricEntity, SyncMetricEntity, QSortBy> {
  ...
  QueryBuilder<SyncMetricEntity, SyncMetricEntity, QAfterSortBy> sortById() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncMetricEntityQuerySortThenBy
    on QueryBuilder<SyncMetricEntity, SyncMetricEntity, QSortThenBy> {
  QueryBuilder<SyncMetricEntity, SyncMetricEntity, QAfterSortBy>
      thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
  ...
  QueryBuilder<SyncMetricEntity, SyncMetricEntity, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }
...
extension SyncMetricEntityQueryWhereDistinct
    on QueryBuilder<SyncMetricEntity, SyncMetricEntity, QDistinct> {
  ...
  QueryBuilder<SyncMetricEntity, SyncMetricEntity, QDistinct> distinctById(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetricEntity, SyncMetricEntity, QDistinct> distinctByUserId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncMetricEntityQueryProperty
    on QueryBuilder<SyncMetricEntity, SyncMetricEntity, QQueryProperty> {
  QueryBuilder<SyncMetricEntity, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetricEntity, int, QQueryOperations> durationProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'duration');
    });
  }

  QueryBuilder<SyncMetricEntity, String, QQueryOperations>
      entityTypeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetricEntity, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetricEntity, String, QQueryOperations> metricIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'metricId');
    });
  }

  QueryBuilder<SyncMetricEntity, SyncOperation, QQueryOperations>
      operationProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetricEntity, int, QQueryOperations> recordCountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'recordCount');
    });
  }

  QueryBuilder<SyncMetricEntity, bool, QQueryOperations> successProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'success');
    });
  }

  QueryBuilder<SyncMetricEntity, SyncStatus, QQueryOperations>
      syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
